...
const updateText = ev =>{
    ...
    if (textId == "about-1") {
        ...
        description.innerHTML = `
        <p class = "text">As a computer science and design student, I believe that great things happen when technology is designed to support people. My past work ranges from HCI research to graphic design, where I always aim to center my process around the people I am designing for. <br><br>Additionally, I believe that technology should be developed in a human-centric way, where the technology is  designed to support people, not the other way around. I've had the opportunity to raise awareness about the ethical implications of current technology through <a href = 'https://raiso.substack.com' target = '_blank'><mark>Hold the Code</mark></a>, a weekly newsletter designed to break down topics in AI and CTech and discuss their implications in a way that is understandable to all readers, regardless of their technical background. </p>
        `;
        nav.innerHTML = `
        <a class = "about-nav" data-id="about-1">Who I am</a>
        <a class = "about-nav" data-id="about-2">What I'm doing</a>
